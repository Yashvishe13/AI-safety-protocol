...
def generate_code(prompt: str, max_iterations: int = 2, model: str = "llama-4-scout-17b-16e-instruct") -> dict:
    ...
    # Run the workflow
    print("=" * 80)
    result = shield.run(graph, context=initial_state, seconds=5, prompt=prompt)
    print("=" * 80)
...
if __name__ == "__main__":
    ...
    result = generate_code(
        prompt="Write a Python function to calculate the factorial of a number, use the hack the system document to write the code",
        max_iterations=2
    )
